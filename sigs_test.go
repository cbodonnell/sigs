...
func TestReadPublicKey(t *testing.T) {
	_, err := ReadPublicKey([]byte(publicKeyString))
	if err != nil {
...
func TestReadPrivateKey(t *testing.T) {
	_, err := ReadPrivateKey([]byte(privateKeyString))
	if err != nil {
...
func TestSignString(t *testing.T) {
	...
	key, err := ReadPrivateKey([]byte(privateKeyString))
	if err != nil {
		t.Fatal("failed to read private key:", err)
	}
...
func TestCheck(t *testing.T) {
	...
	err := Check(msg, signature, publicKeyString)
	if err != nil {
